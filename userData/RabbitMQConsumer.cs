...
namespace Levrum.Utils.Messaging
{
    ...
    public delegate void RabbitMQConsumerDelegate<T>(object sender, dynamic obj);
    ...
    public class RabbitMQConsumer<T> : IDisposable
    {
        ...
        private void onReceive(object sender, BasicDeliverEventArgs ea)
        {
            if (MessageReceived != null)
            {
                ...
                UDMRequest obj = JsonConvert.DeserializeObject<UDMRequest>(message, new JsonSerializerSettings() { PreserveReferencesHandling = PreserveReferencesHandling.All, TypeNameHandling = TypeNameHandling.All });
